---
title: 'Docker'
description: 'Learn how to install Cachet on your server with Docker.'
icon: 'docker'
---
...
[Easypanel](https://easypanel.io/) can deploy Cachet with one click using its [official template](https://easypanel.io/templates/cachet), which provisions the required PostgreSQL database automatically.
